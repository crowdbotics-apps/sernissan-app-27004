...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <TouchableOpacity
        onPress={() =>
          this.props.navigation.navigate(getNavigationScreen("293_1"))
        }
      >
        <View style={styles.View_284_1870}>
          <View style={styles.View_I284_1870_281_1544}>
            <View style={styles.View_I284_1870_281_1545}>
              <View style={styles.View_I284_1870_281_1546} />
              <View style={styles.View_I284_1870_281_1547} />
            </View>
            <View style={styles.View_I284_1870_281_1548} />
          </View>
          <View style={styles.View_I284_1870_281_1549}>
            <Text style={styles.Text_I284_1870_281_1549}>
      ...
      >
        <View style={styles.View_284_1871} />
      </TouchableOpacity>
      <View style={styles.View_284_1872}>
        <Text style={styles.Text_284_1872}>RECUPERAR CONTRASEÑA</Text>
      </View>
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <ImageBackground
          ...
          style={styles.ImageBackground_284_1894}
        />
      </TouchableOpacity>
      <View style={styles.View_357_146}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/404e/0ff8/2f7c56d67be041bfce26e4bac6a05dc8"
          }}
          style={styles.ImageBackground_357_147}
        />
      </View>
    </ScrollView>
  )
