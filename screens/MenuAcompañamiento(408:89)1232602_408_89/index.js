...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_408_91} />
      <View style={styles.View_408_92}>
        <View style={styles.View_408_93}>
          <Text style={styles.Text_408_93}>Perfil</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_408_95}
        />
      </View>
      <View style={styles.View_408_98}>
        <View style={styles.View_408_99}>
          <Text style={styles.Text_408_99}>Monitoreo</Text>
        </View>
        <View style={styles.View_408_100}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2f7a/5a45/7ccf5a1bbe312484705b37229addbd74"
            }}
            style={styles.ImageBackground_I408_100_0_109}
          />
        </View>
      </View>
      <View style={styles.View_408_101}>
        <View style={styles.View_408_102}>
          <Text style={styles.Text_408_102}>Plan</Text>
        </View>
        <View style={styles.View_408_103}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1991/5d3c/8edb7e6ee72f30e5990ded54f9160f22"
            }}
            style={styles.ImageBackground_I408_103_0_653}
          />
        </View>
      </View>
      <View style={styles.View_408_104}>
        <View style={styles.View_408_105}>
          <Text style={styles.Text_408_105}>Notas</Text>
        </View>
        <ImageBackground
          source={{
            uri:
          ...
          style={styles.ImageBackground_408_106}
        />
      </View>
    </ScrollView>
  )
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I408_100_0_109: {
    flexGrow: 1,
  ...
  ImageBackground_I408_103_0_653: {
    flexGrow: 1,
