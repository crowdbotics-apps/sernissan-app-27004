...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      >
        <View style={styles.View_357_46}>
          <View style={styles.View_I357_46_281_1544}>
            <View style={styles.View_I357_46_281_1545}>
              <View style={styles.View_I357_46_281_1546} />
              <View style={styles.View_I357_46_281_1547} />
            </View>
            <View style={styles.View_I357_46_281_1548} />
          </View>
          <View style={styles.View_I357_46_281_1549}>
            <Text style={styles.Text_I357_46_281_1549}>Ingresar TOKEN</Text>
          </View>
        </View>
      </TouchableOpacity>
      <View style={styles.View_357_47} />
      <View style={styles.View_357_48}>
        <Text style={styles.Text_357_48}>Iniciar Sesión</Text>
      </View>
      <View style={styles.View_357_102}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/404e/0ff8/2f7c56d67be041bfce26e4bac6a05dc8"
          }}
          style={styles.ImageBackground_357_103}
        />
      </View>
    </ScrollView>
  )
